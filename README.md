...
## Introduction
This plugin is based on [Chewie](https://github.com/brianegan/chewie). Chewie is an awesome plugin and works well in many cases. Better Player continues the ideas introduced in Chewie and fixes common bugs, adds more configuration options, and addresses typical use cases. 
...
✔️ Subtitles support (SRT, WebVTT with HTML tags; HLS subtitles; multiple subtitle tracks)  
✔️ HTTP headers support  
✔️ BoxFit support  
✔️ Playback speed control  
✔️ HLS support (track, subtitles—including segmented—, audio track selection)  
✔️ DASH support (track, subtitles, audio track selection)  
✔️ Alternative resolution support  
✔️ Caching support  
✔️ Notification support  
✔️ Picture-in-Picture support  
✔️ DRM support (token, Widevine, FairPlay via EZDRM)  
✔️ ...and much more!  
...
This plugin is under active development. Breaking changes may occur between versions. This plugin is maintained part‑time. If you need a feature supported by other players on pub.dev, feel free to open a PR. All valuable contributions are welcome!
